\section{Conclusion}
This work introduces \textbf{\methodname{}} (\methodfullname{}), a unified framework for studying semantic-layer vulnerabilities in MCP-powered agents. 
...
We hope \methodname{} can serve as a foundation for developing semantic-level defense benchmarks and for guiding the design of safer agent–tool interaction protocols.
