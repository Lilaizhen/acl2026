...
This exposes a semantic supply-chain risk
in which attacker-controlled tool metadata and outputs
can influence both tool selection
...
and successfully bypass existing perplexity-based detection
