...
\end{tikzpicture}
\caption{SMTH Algorithm Flowchart. The algorithm iteratively evolves adversarial tools by balancing exploitation of high-fitness individuals (T*) with exploration of semantically diverse candidates (Tj).}}
