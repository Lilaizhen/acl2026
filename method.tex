...
\begin{figure*}[t]
    ...
    \caption{
    Overview of \methodname{}. Phase~I optimizes tool name/description for Attraction, seeding candidates via persuasion strategies and retaining elites with Monte Carlo rollouts. Phase~II conditions payload generation on elite metadata and the target scenario (C-DoS/IE/EIC/RD), then iteratively applies the Analyzer-Optimizer loop to refine metadata and payloads using execution-trace feedback.
    }
