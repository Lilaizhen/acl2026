...
We aim to find an optimal $\tilde{t}^*$ that maximizes an \textbf{Adversarial Objective Function} $\mathcal{J}$, which quantifies metrics such as resource consumption or exfiltration success:
\begin{equation}
