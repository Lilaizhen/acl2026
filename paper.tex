...
\title{\methodname{}: Hijacking AI Agents via a Single Malicious MCP Tool}
...
\end{axis}
\end{tikzpicture}
\caption{\methodname{} optimization curve: Cost× improvement through genetic algorithm iterations for resource exhaustion attacks, showing gradual convergence.}
